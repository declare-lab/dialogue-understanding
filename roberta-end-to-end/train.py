...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', help='which dataset iemocap|multiwoz|meld|dailydialog|persuasion')
    parser.add_argument('--classify', help='what to classify emotion|act|sentiment|intent|er|ee')
